...
try "Calling linuxdeployqt..." linuxdeployqt "$DEPLOYROOT"/usr/share/applications/TARSISETC.desktop -bundle-non-qt-libs -extra-plugins=iconengines,platformthemes/libqgtk3.so
